export default {
	async fetchData() {
		try {
			...
			const transaction = result3[0]['total']
			...
			return { total_questions: total_questions, no_information_found: no_information_found, answered_questions: answered_questions, total_transactions: transaction };
		} catch (error) {
